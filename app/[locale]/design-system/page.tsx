 ...
 *
 * Deliberately not translated. It is a developer surface, it is `noindex`, and
 * putting its sample copy in the catalogue would mean a translator maintaining
 * strings no customer will ever read. Both locales serve it; both serve it in
 * English. The one thing worth checking here in Nepali is line height and
 * descender clipping in Devanagari, and for that the real screens are better
