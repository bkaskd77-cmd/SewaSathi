 ...
 *
 * Every primitive rendered against real Sewa[X] content rather than "Lorem"
 * and a grid of grey boxes, so we can judge whether the identity survives
 * contact with an actual provider card. Phase 2 replaces this with the
 * marketing page; the primitives stay.
 */
