  ...
  const rows = [
    {
      icon: User,
      label: "Name",
      value: profile.fullName?.trim() || "Not set yet",
    ...
    <div className="mx-auto w-full max-w-2xl">
      <header className="animate-rise">
        ...
        <p className="mt-2 text-body-md text-muted-foreground">
          What we know about you, and what your professional sees when you book.
        </p>
      </header>
      ...
      >
        ...
        and we&rsquo;ll update it — editing here arrives with addresses and
        payment.
      </p>
